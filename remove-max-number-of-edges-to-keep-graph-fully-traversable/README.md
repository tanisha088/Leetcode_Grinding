<h2>1579. Remove Max Number of Edges to Keep Graph Fully Traversable</h2><h3>Hard</h3><hr><div><p>Alice and Bob have an undirected graph of&nbsp;<code>n</code>&nbsp;nodes&nbsp;and 3 types of edges:</p>
